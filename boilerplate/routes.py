...
_routes.append(RedirectRoute('/settings/my-profile/edit-item/', handlers.EditItemIntermediaryHandler, name='edit-item-inter', strict_slash=True))
_routes.append(RedirectRoute('/settings/my-profile/edit-item/', handlers.EditItemHandler, name='edit-item', strict_slash=True))
